...
# Run program
python eval.py --dataset_name "sst2" --lfm "first-k" --batch_sizes 1 --n_ctxt 2 --ctxt_style "vary" --K_models 1 --model_path "bigscience/bloom-560m" --rng_offset ${SLURM_ARRAY_TASK_ID} --config config_eval_rep.json